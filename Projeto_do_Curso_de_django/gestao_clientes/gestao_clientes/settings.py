...
ALLOWED_HOSTS = ['gestao-clientes2.herokuapp.com', '127.0.0.1']
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'mirello' #quando eu quiser é so colocar o meu email
EMAIL_HOST_PASSWORD = 'bbdgbfnfnfnfn'  #quando eu quiser é so colocar a senha
